...
description: Learn how to configure Vite using vite.config.js, including config file resolution, TypeScript support, conditional and async configs, and environment variables.
---

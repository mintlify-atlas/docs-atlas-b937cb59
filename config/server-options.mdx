...
description: Configuration options for Vite's development server, including host, port, proxy, CORS, HMR, and file watching.
---
...
<details>
<summary>What hosts are safe to be added?</summary>
...
<details>
<summary>Configure via environment variable</summary>

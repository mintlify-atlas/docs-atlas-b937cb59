---
title: Build Options
description: Configuration options for building your Vite project, including target browsers, output directories, minification, and library mode.
---
...
<Note>
The polyfill does **not** apply to [Library Mode](/guide/build#library-mode). If you need to support browsers without native dynamic import, you should probably avoid using it in your library.
</Note>

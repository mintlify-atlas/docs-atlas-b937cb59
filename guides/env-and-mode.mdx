...
description: Learn how to use environment variables and modes in Vite for different deployment environments
---
...
<ParamField path="import.meta.env.MODE" type="string">
  The [mode](#modes) the app is running in.
</ParamField>

<ParamField path="import.meta.env.BASE_URL" type="string">
  The base url the app is being served from. This is determined by the [`base` config option](/config/shared-options#base).
</ParamField>
...
<ParamField path="import.meta.env.SSR" type="boolean">
  Whether the app is running in the [server](/guides/server-side-rendering#conditional-logic).
</ParamField>
...
Vite uses [dotenv-expand](https://github.com/motdotla/dotenv-expand) to expand variables written in env files out of the box. To learn more about the syntax, check out [their docs](https://github.com/motdotla/dotenv-expand#what-rules-does-the-expansion-engine-follow).

---
title: Using Plugins
description: Extend Vite with plugins based on Rollup's plugin interface with Vite-specific options
---
...
<Steps>
  <Step title="Install the plugin">
    For example, to provide support for legacy browsers, install the official `@vitejs/plugin-legacy`:
  ...
  <Step title="Add to configuration">
    Include the plugin in your `vite.config.js` file:
